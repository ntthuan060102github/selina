...
export default function CheckoutBody({ set_has_token }) {
        ...
        <div className="checkout-body">
            <div className="checkout-body__personal-info">
                ...
                <div className="checkout-body__form-inputs">
                    <input type="text" className="checkout-body__form-input" id="checkout-body__user-address" />
                    <input type="text" className="checkout-body__form-input" id="checkout-body__user-phone-number" />
                </div>
            </div>
